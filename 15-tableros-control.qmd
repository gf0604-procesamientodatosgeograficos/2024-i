...
## Ejercicios
1. Organice en un tablero de control las visualizaciones de datos sobre riesgo de atropello de especies de mamíferos alrededor de la ruta 32. Incluya:

    a. Una tabla DT con las especies en mayor riesgo y la cantidad de registros.
    b. Un gráfico Plotly que muestre la misma información que el punto a.
    c. Un mapa Leaflet que muestre la zona de riesgo y los registros de presencia.
    
2. Agregue tablas, gráficos y mapas adicionales que considere de impoortancia.
3. Publique el tablero de control como un sitio en GitHub Pages.
