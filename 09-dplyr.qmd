...
- [Estadísticas de delitos cometidos en 2023](https://sitiooij.poder-judicial.go.cr/phocadownload/Estadisticas/estadsticaspoliciales2023.xlsx), disponibles en el [sitio Datos Abiertos del Organismo de Investigación Judicial (OIJ)](https://sitiooij.poder-judicial.go.cr/index.php/ayuda/servicios-policiales/servicios-a-organizaciones/indice-de-transparencia-del-sector-publico-costarricense/datos-abiertos).
...
### Estadísticas de delitos cometidos en 2023
...
```{r}
#| label: carga-estadisticaspoliciales2023
#| message: false
...
```{r}
#| label: estructura-estadisticaspoliciales2023
...
# Despliegue de una muestra de los datos de delitos cometidos en 2023
delitos_2023[, c("Delito", "SubDelito", "Victima", "Fecha", "Provincia", "Canton", "Distrito")] |>
  head(n = 10) |>
  kable(format = "html")
```
